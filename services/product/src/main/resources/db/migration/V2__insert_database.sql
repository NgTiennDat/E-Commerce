-- Insert into category (không cần id vì auto_increment)
INSERT INTO category (description, name) VALUES ('Computer Keyboards', 'Keyboards');
INSERT INTO category (description, name) VALUES ('Computer Monitors', 'Monitors');
INSERT INTO category (description, name) VALUES ('Display Screens', 'Screens');
INSERT INTO category (description, name) VALUES ('Computer Mice', 'Mice');
INSERT INTO category (description, name) VALUES ('Computer Accessories', 'Accessories');

-- Insert products for the 'Keyboards' category
INSERT INTO products (available_quantity, description, name, price, category_id) VALUES
